...
const txHeader = (tx, { tipHeight, mempool, feeEst, t
                      , txAnalysis: { feerate, discountfeerate, mempoolDepth, confEstimate, overpaying, privacyAnalysis, segwitGains } }) => {
  ...
  <div className="stats-table font-p2">
    ...
    { feerate != null && <div>
      ...
      <div>
        <span className="amount">{t`${formatSat(tx.fee)}`} {formatFeeRate(feerate, discountfeerate, tx)}</span>
